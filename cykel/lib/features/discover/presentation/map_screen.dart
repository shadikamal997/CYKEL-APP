              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: IconButton(
                    ...
                    color: isSaved ? _kPrimaryColor : context.colors.textSecondary,
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: sel
                                ...
                                : context.colors.surfaceVariant.withValues(alpha: 0.4),
                            borderRadius: BorderRadius.circular(6),
                          ...
                          child: Icon(
                            p.icon,
                            size: 14,
                            color: sel ? _kPrimaryColor : context.colors.textSecondary,
                          ),
                        ),
                      );
                    }).toList(),
                    ...
                    return Expanded(
                      child: GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            color: sel ? _kPrimaryColor : context.colors.surfaceVariant.withValues(alpha: 0.4),
                            borderRadius: BorderRadius.circular(8),
                            border: Border.all(
                              color: sel ? _kPrimaryColor : context.colors.surfaceVariant,
                              width: sel ? 1.5 : 1,
                            ),
                          ),
                          child: Column(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    r.distanceLabel,
                                    style: TextStyle(
                                      color: sel ? Colors.white : context.colors.textPrimary,
                                      fontWeight: FontWeight.w600,
                                      fontSize: 11,
                                    ),
                                  ),
                              ...
                              Text(
                                r.durationLabel,
                                style: TextStyle(
                                  color: sel ? Colors.white.withValues(alpha: 0.85) : context.colors.textSecondary,
                                  fontSize: 10,
                                ),
                              ),
                            ],
          ...
          child: Row(
            ...
            children: [
              Icon(
                icon,
                size: 12,
                color: selected ? _kPrimaryColor : context.colors.textSecondary,
              ),
              const SizedBox(width: 3),
              Flexible(
                child: Text(
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Icon(Icons.filter_list_rounded, size: 16, color: context.colors.textSecondary),
                      const SizedBox(width: 8),
                      Text(
                        'Filters',
                        style: AppTextStyles.bodyMedium.copyWith(
                  ...
                  SwitchListTile(
                    ...
                    dense: true,
                    secondary: Icon(Icons.access_time_rounded, size: 20, color: context.colors.textSecondary),
                    ...
                    Row(
                      children: [
                        ...
                        if (_calculateDistance() != null) ...[
                          Icon(Icons.directions_walk_rounded, size: 14, color: context.colors.textSecondary),
                          const SizedBox(width: 2),
                          Text(
