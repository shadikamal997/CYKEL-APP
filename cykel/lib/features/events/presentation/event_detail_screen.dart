...
class _EventDetailScreenState extends ConsumerState<EventDetailScreen> {
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildPremiumHeader(event),
                          _buildParticipantsRow(event),
                          const SizedBox(height: 24),
                          _buildPremiumInfoRows(event),
                          if (event.description != null) 
                            _buildPremiumDescription(event),
                          _buildPremiumOrganizerSection(event),
                        ],
                      ),
                    ),
                  );
  ...
  Widget _buildOrganizerMenu(RideEvent event) {
    return Container(
      width: 44,
      height: 44,
      decoration: BoxDecoration(
  ...
  Widget _buildPremiumHeader(RideEvent event) {
    return Padding(
  ...
  Widget _buildPremiumBadge({required String text}) {
    return Container(
  ...
  Widget _buildParticipantsRow(RideEvent event) {
  ...
  Widget _buildPremiumInfoRows(RideEvent event) {
    return Column(
      children: [
        // Date & Time row
        _buildInfoRow(
  ...
  Widget _buildPremiumDescription(RideEvent event) {
    return Container(
  ...
  Widget _buildPremiumOrganizerSection(RideEvent event) {
    return Container(
      margin: const EdgeInsets.fromLTRB(16, 16, 16, 0),
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
  ...
  Widget _buildJoinButton(RideEvent event, user) {
    ...
    return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        backgroundColor: isDisabled ? context.colors.border : _kPrimaryColor,
        foregroundColor: isDisabled ? context.colors.textHint : Colors.white,
        minimumSize: const Size.fromHeight(54),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(27),
        ),
