...
class _EventsScreenState extends ConsumerState<EventsScreen> {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        ...
        slivers: [
          // ─── Hero Header Section ─────────────────────────────────────────
          SliverToBoxAdapter(
            child: _buildHeroHeader(context, l10n),
          ),

          // ─── Tab Pills ───────────────────────────────────────────────────
          SliverToBoxAdapter(
            child: _buildTabPills(context, l10n),
          ),

          // ─── Filter & Sort Bar ───────────────────────────────────────────
          SliverToBoxAdapter(
            child: _buildFilterSortBar(context, l10n),
          ),
          ...
          SliverToBoxAdapter(
            child: _buildTrendingEvents(context, screenWidth),
          ),
          ...
          // ─── New Rides Cards ─────────────────────────────────────────────
          SliverToBoxAdapter(
            child: _buildNewEvents(context, screenWidth),
          ),
          ...
          // ─── Nearby Events Cards ─────────────────────────────────────────
          SliverToBoxAdapter(
            child: _buildNearbyEvents(context, screenWidth),
          ),
          ...
          SliverToBoxAdapter(
            child: _buildWeekendEvents(context, screenWidth),
          ),
          ...
          SliverToBoxAdapter(
            child: _buildHorizontalEventCards(context, screenWidth),
          ),
      ...
      floatingActionButton: _buildCreateFAB(context, l10n),
    );
  }
  ...
  // ─── Tab Pills ───────────────────────────────────────────────────────────────
  Widget _buildTabPills(BuildContext context, AppLocalizations l10n) {
    final tabs = [
      l10n.eventsTabAll,
      l10n.eventsTabMine,
  ...
  // ─── Filter & Sort Bar ───────────────────────────────────────────────────────
  Widget _buildFilterSortBar(BuildContext context, AppLocalizations l10n) {
      ...
      child: ListView(
        ...
        children: [
          ...
          _buildFilterChip(
            ...
            onTap: () => _showEventTypeFilter(context),
          ),
          const SizedBox(width: 8),
          // Difficulty filter
          _buildFilterChip(
      ...
      builder: (context) => SafeArea(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            _buildSortOption(context, 'date', 'Sort by Date', Icons.calendar_today),
            _buildSortOption(context, 'distance', 'Sort by Distance', Icons.near_me),
            _buildSortOption(context, 'participants', 'Sort by Popularity', Icons.people),
            const SizedBox(height: 20),
          ],
        ),
      ),
  ...
  Widget _buildSortOption(BuildContext context, String value, String label, IconData icon) {
    ...
    return ListTile(
      leading: Icon(icon, color: isSelected ? _kPrimaryColor : (_kSecondaryText)),
      title: Text(
        label,
        style: TextStyle(
          fontWeight: isSelected ? FontWeight.w600 : FontWeight.w400,
          color: isSelected ? _kPrimaryColor : (_kPrimaryText),
        ),
      ),
      ...
      builder: (context) => SafeArea(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            _buildDifficultyOption(context, 'all', 'All Levels'),
            _buildDifficultyOption(context, 'easy', 'Easy'),
            _buildDifficultyOption(context, 'moderate', 'Moderate'),
            _buildDifficultyOption(context, 'hard', 'Hard'),
            const SizedBox(height: 20),
          ],
        ),
      ),
  ...
  Widget _buildDifficultyOption(BuildContext context, String value, String label) {
              ...
              Flexible(
                child: SingleChildScrollView(
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      _buildAgeOption(context, 'all', 'All Ages'),
                      _buildAgeOption(context, '18+', '18+'),
                      _buildAgeOption(context, '21+', '21+'),
                      _buildAgeOption(context, '16-25', '16-25'),
                      _buildAgeOption(context, '26-40', '26-40'),
                      _buildAgeOption(context, '41-60', '41-60'),
                      _buildAgeOption(context, '60+', '60+'),
                    ],
                  ),
                ),
              ),
  ...
  Widget _buildAgeOption(BuildContext context, String value, String label) {
              ...
              Flexible(
                child: SingleChildScrollView(
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      _buildLanguageOption(context, 'all', 'All Languages'),
                      _buildLanguageOption(context, 'da', 'Danish'),
                      _buildLanguageOption(context, 'en', 'English'),
                      _buildLanguageOption(context, 'de', 'German'),
                      _buildLanguageOption(context, 'sv', 'Swedish'),
                      _buildLanguageOption(context, 'no', 'Norwegian'),
                      _buildLanguageOption(context, 'fr', 'French'),
  ...
  void _showEventTypeFilter(BuildContext context) {
    showModalBottomSheet(
      context: context,
      backgroundColor: context.colors.surface,
      shape: const RoundedRectangleBorder(
              ...
              Flexible(
                child: SingleChildScrollView(
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      _buildEventTypeOption(context, 'all', 'All Types'),
                      _buildEventTypeOption(context, 'social', 'Social'),
                      _buildEventTypeOption(context, 'training', 'Training'),
                      _buildEventTypeOption(context, 'tour', 'Tour'),
                      _buildEventTypeOption(context, 'beginner', 'Beginner'),
                      _buildEventTypeOption(context, 'family', 'Family'),
                      _buildEventTypeOption(context, 'night', 'Night'),
                      _buildEventTypeOption(context, 'gravel', 'Gravel/MTB'),
                      _buildEventTypeOption(context, 'expat', 'Expat'),
                      _buildEventTypeOption(context, 'race', 'Race'),
                    ],
                  ),
                ),
              ),
  ...
  Widget _buildEventTypeOption(BuildContext context, String value, String label) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [_kPrimaryColor.withValues(alpha: 0.05), _kPrimaryColor.withValues(alpha: 0.1)],
        ),
        borderRadius: BorderRadius.circular(20),
        border: Border.all(
  ...
  // ─── Trending Events ─────────────────────────────────────────────────────────
  Widget _buildTrendingEvents(BuildContext context, double screenWidth) {
  ...
  // ─── New Events ──────────────────────────────────────────────────────────────
  Widget _buildNewEvents(BuildContext context, double screenWidth) {
    final eventsAsync = ref.watch(upcomingEventsProvider);
  ...
  // ─── Nearby Events ───────────────────────────────────────────────────────────
  Widget _buildNearbyEvents(BuildContext context, double screenWidth) {
    final eventsAsync = ref.watch(upcomingEventsProvider);
  ...
  // ─── Weekend Events ──────────────────────────────────────────────────────────
  Widget _buildWeekendEvents(BuildContext context, double screenWidth) {
    final eventsAsync = ref.watch(upcomingEventsProvider);
  ...
  Widget _buildHorizontalEventCards(BuildContext context, double screenWidth) {
    final eventsAsync = ref.watch(upcomingEventsProvider);
  ...
  Widget _buildEventList(BuildContext context) {
    ...
    if (_selectedTabIndex == 2) {
      ...
      return eventsAsync.when(
        ...
        data: (events) => _buildEventListContent(context, events),
      );
    }
  ...
  Widget _buildEventListContent(BuildContext context, List<RideEvent> events) {
    if (events.isEmpty) {
  ...
  // ─── Create FAB ──────────────────────────────────────────────────────────────
  Widget _buildCreateFAB(BuildContext context, AppLocalizations l10n) {
    return Container(
      decoration: BoxDecoration(
