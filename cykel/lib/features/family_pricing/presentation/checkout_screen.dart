...
class _TrialToggle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: startTrial ? AppColors.successLight : context.colors.surface,
        borderRadius: BorderRadius.circular(12),
        border:
      ...
      child: Row(
        children: [
          Icon(
            ...
            color: startTrial ? AppColors.success : context.colors.textSecondary,
          ),
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    fontWeight: FontWeight.w600,
                    color:
                        startTrial ? AppColors.success : context.colors.textPrimary,
                  ),
                ),
                Text(
                  startTrial
