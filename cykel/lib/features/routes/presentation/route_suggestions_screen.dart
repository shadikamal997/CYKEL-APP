...
class _SuggestionCardState extends State<_SuggestionCard> {
  ...
  Color _scoreColor(BuildContext context, double score) {
    if (score >= 80) return Colors.black.withValues(alpha: 1.0);
    if (score >= 60) return Colors.black.withValues(alpha: 0.8);
    if (score >= 40) return Colors.black.withValues(alpha: 0.6);
